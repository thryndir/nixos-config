...
in
{
  xdg.configFile."aichat/dark.tmTheme".text = with colors; ''
<?xml version="1.0" encoding="UTF-8"?>
<!DOCTYPE plist PUBLIC "-//Apple//DTD PLIST 1.0//EN" "http://www.apple.com/DTDs/PropertyList-1.0.dtd">
<plist version="1.0">
  <dict>
    <key>comment</key>
    <string>Generated via Nix/Stylix</string>
    ...
    <array>
      <dict>
        ...
        <dict>
          ...
          <key>foreground</key>
          <string>#${base05}80</string>
          <key>invisibles</key>
          <string>#${base05}26</string>
